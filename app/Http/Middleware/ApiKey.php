...
class ApiKey
{
    ...
    public function handle(Request $request, Closure $next): Response
    {
        ...
        if(intval($userApiKey->saldo) <= 50)
        {
            return response()->json(['pesan'=>"Mohon maaf, saldo anda tidak mencukupi! silahkan melakukan isi ulang saldo di web Hikmah Learn!", 'status' => 401], 401);
        }
